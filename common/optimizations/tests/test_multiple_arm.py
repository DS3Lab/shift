...
request = HyperbandRequest(
    ...
    models=[
        ...
        TFFullTextModelConfig(
            tf_text_model_url="https://tfhub.dev/google/nnlm-en-dim50/2",
        ),
        TFFullTextModelConfig(
            tf_text_model_url="https://tfhub.dev/google/nnlm-en-dim50-with-normalization/2"
        ),
    ],
    chunk_size=4096,
)
...
class TestSuccessiveHalving(unittest.TestCase):
    ...
    def test_successive_halving_with_doubling(self):
        ...
        algorithm.successive_halving_with_doubling(eta=2, snoopy=True)
